    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="row">
        ...
        <div class="col">
          <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">Online</label>
            <input type="number" class="form-control" id="online" placeholder="Amout" name="online" onkeyup="oncpp();">
          </div>
        </div>
       </div>
       <div class="row">
        ...
        <div class="col">
          <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">Cash</label>
            <input type="number" class="form-control" id="cash" placeholder="Amout" name="cash" onkeyup="oncpp();">
          </div>
        </div>
       </div>
       <div class="row">
        ...
        <div class="col">
          <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">old Credit Amount</label>
            <input type="text" class="form-control" id="old" placeholder="Amout" disabled>
          </div>
        </div>
       </div>
       <div class="row">
        <div class="col">
          <div class="form-group">
            ...
            <select class="form-control select2" style="width: 100%;">
              <option selected="selected" disabled>Total Amount</option>
            </select>
          </div>
        </div>
        <div class="col">
          <div class="mb-3">
            ...
            <input type="text" id="tot" class="form-control" name="totaleBill" onkeyup="oncpp();" value="" class="text-center" readonly>
          </div>
        </div>
       </div>
      </div>
